"""# Writing TCP Servers and Clients
   ...
   To create a TCP server you call the [[io.vertx.ceylon::Vertx.createNetServer]] method on your vertx instance.
   ...
   - [[io.vertx.ceylon::ServerBase.tcpNoDelay]] If true then [Nagle's Algorithm](http://en.wikipedia.org/wiki/Nagle's_algorithm) is disabled. If false then it is enabled.
   - [[io.vertx.ceylon::NetworkBase.sendBufferSize]] Sets the TCP send buffer size in bytes.   
   - [[io.vertx.ceylon::NetworkBase.receiveBufferSize]] Sets the TCP receive buffer size in bytes.
   - [[io.vertx.ceylon::ServerBase.tcpKeepAlive]] if tcpKeepAlive is true then TCP keep alive is enabled, if false it is disabled.
   - [[io.vertx.ceylon::NetworkBase.reuseAddress]] if reuse is true then addresses in TIME_WAIT state can be reused after they have been closed.
   - [[io.vertx.ceylon::ServerBase.soLinger]]
   - [[io.vertx.ceylon::NetworkBase.trafficClass]]
   ...
   To read data from the socket you need to set the [[io.vertx.ceylon.stream::ReadStream.dataHandler]] on the [[NetSocket.readStream]].
   ...
   NetSocket provide access to [[io.vertx.ceylon.net::NetSocket.readStream]] and [[io.vertx.ceylon.net::NetSocket.writeStream]].
   ...
   To create a TCP client you call the [[io.vertx.ceylon::Vertx.createNetClient]] method on your vertx instance.
