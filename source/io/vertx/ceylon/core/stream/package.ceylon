"""# Flow Control - Streams and Pumps
   ...
   A very simple example would be reading from a [[io.vertx.ceylon.core.net::NetSocket]] on a server and writing back to
   the same [[io.vertx.ceylon.core.net::NetSocket]] - since [[io.vertx.ceylon.core.net::NetSocket]] provides both [[ReadStream]] and
   ...
   to the socket, it will build up in the write queue of the [[io.vertx.ceylon.core.net::NetSocket]], eventually running out of RAM.
   ...
   to do is pause the [[io.vertx.ceylon.core.net::NetSocket]] when the write queue is full. Let's do that:
   ...
   """
shared package io.vertx.ceylon.core.stream;
