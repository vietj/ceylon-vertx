"""# Writing HTTP Servers and Clients
   ...
   * [[jsonBody]] : provides a `ceylon.json.Object` for mime type `application/json`
   ...
   To create an HTTP client you call the [[io.vertx.ceylon.core::Vertx.createHttpClient]] method on your vertx instance:
   ...
   and to write to the request body. The request object implements [[io.vertx.ceylon.core.stream::WriteStream]].
   ...
   [[io.vertx.ceylon.core.stream::WriteStream]] like any other [[io.vertx.ceylon.core.stream::ReadStream]].
   ...
   [[io.vertx.ceylon.core.stream::WriteStream]]. See the chapter on streams and pump for a detailed explanation.
   ...
   The `websocket` instance passed into the handler provides access to the [[io.vertx.ceylon.core.stream::ReadStream]] and
   [[io.vertx.ceylon.core.stream::WriteStream]], so you can read and write data to it in the normal ways. I.e by setting a
   [[io.vertx.ceylon.core.stream::ReadStream.dataHandler]] and calling the [[io.vertx.ceylon.core.stream::WriteStream.write]]
   method.
   ...
   Again, the client side WebSocket implements [[io.vertx.ceylon.core.stream::ReadStream]] and [[io.vertx.ceylon.core.stream::WriteStream]],
