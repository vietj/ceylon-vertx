...
import io.vertx.ceylon.core.util { FunctionalHandlerAdapter, HandlerPromise }
...
"""Represents an HTML 5 Websocket
   ...
   It provides access to both [[io.vertx.ceylon.core.stream::ReadStream]] and [[io.vertx.ceylon.core.stream::WriteStream]] so
