import io.vertx.ceylon.core { Registration, Vertx }
import ceylon.promise { Promise, Deferred }
import io.vertx.ceylon.core.eventbus { Message, EventBus, Payload }
import ceylon.test { ... }
import ceylon.json { JSonObject=Object, JSonArray=Array }
import test.io.vertx.ceylon.core { assertResolve, toByteArray, with, eventBus  }
