...
shared test
void testSharedMapInteger() => with(sharedData(testMap(0, 4, (Integer item1, Integer item2) => item1.equals(item2))));
shared test
void testSharedMapString() => with(sharedData(testMap("foo", "bar", (String item1, String item2) => item1.equals(item2))));
shared test
void testSharedMapFloat() => with(sharedData(testMap(0.4, 0.5, (Float item1, Float item2) => item1.equals(item2))));
shared test
void testSharedMapBoolean() => with(sharedData(testMap(true, false, (Boolean item1, Boolean item2) => item1.equals(item2))));
shared test
void testSharedMapByteArray() => with(sharedData(testMap(toByteArray({ 0, 1, 2 }), toByteArray({ 2, 1, 0 }), byteArrayEquals)));

shared test
void testSharedSetInteger() => with(sharedData(testSet(0, (Integer item1, Integer item2) => item1.equals(item2))));
shared test
void testSharedSetString() => with(sharedData(testSet("foo", (String item1, String item2) => item1.equals(item2))));
shared test
void testSharedSetFloat() => with(sharedData(testSet(0.4, (Float item1, Float item2) => item1.equals(item2))));
shared test
void testSharedSetBoolean() => with(sharedData(testSet(true, (Boolean item1, Boolean item2) => item1.equals(item2))));
shared test
void testSharedSetByteArray() => with(sharedData(testSet(toByteArray({ 0, 1, 2 }), byteArrayEquals)));
